...
newattrib(load* this, load* that)
{
	...
	if (!this->attribute)
		...
		if (this->attribute->am_model.am_V_order_id)
			xfree(this->attribute->am_model.am_V_order_id);
		if (this->attribute->am_model.am_V_order_provenience)
			xfree(this->attribute->am_model.am_V_order_provenience);
		if (this->attribute->am_model.am_V_stock_type)
			xfree(this->attribute->am_model.am_V_stock_type);
		if (this->attribute->am_model.am_V_menu_type)
			xfree(this->attribute->am_model.am_V_menu_type);
	}
	if (that != NULL) {
		*(this->attribute) = *(that->attribute);
		if (this->attribute->am_model.am_V_order_id) {
			this->attribute->am_model.am_V_order_id = strdup(that->attribute->am_model.am_V_order_id);
		}
		if (this->attribute->am_model.am_V_order_provenience) {
			this->attribute->am_model.am_V_order_provenience = strdup(that->attribute->am_model.am_V_order_provenience);
		}
		if (this->attribute->am_model.am_V_stock_type) {
			this->attribute->am_model.am_V_stock_type = strdup(that->attribute->am_model.am_V_stock_type);
		}
		if (this->attribute->am_model.am_V_menu_type) {
			this->attribute->am_model.am_V_menu_type = strdup(that->attribute->am_model.am_V_menu_type);
		}
	} else
...
get_ldatt_address(load* this, int32 index, int32* d)
{
	...
	switch(index) {
	case 0:
		data = (void*)&this->attribute->am_model.am_V_order_id;
		break;
	case 1:
		data = (void*)&this->attribute->am_model.am_V_arrival_time;
		break;
	case 2:
		data = (void*)&this->attribute->am_model.am_V_order_provenience;
		break;
	case 3:
		data = (void*)&this->attribute->am_model.am_V_order_dim;
		break;
	case 4:
		data = (void*)&this->attribute->am_model.am_V_drink;
		break;
	case 5:
		data = (void*)&this->attribute->am_model.am_V_chips;
		break;
	case 6:
		data = (void*)&this->attribute->am_model.am_V_menu_pointer;
		break;
	case 7:
		data = (void*)&this->attribute->am_model.am_V_stock_type;
		break;
	case 8:
		data = (void*)&this->attribute->am_model.am_V_stock_location[d[0]];
		break;
	case 9:
		data = (void*)&this->attribute->am_model.am_V_order_ready;
		break;
	case 10:
		data = (void*)&this->attribute->am_model.am_V_order_level;
		break;
	case 11:
		data = (void*)&this->attribute->am_model.am_V_load_ptr;
		break;
	case 12:
		data = (void*)&this->attribute->am_model.am_V_load_type_ptrs[d[0]];
		break;
	case 13:
		data = (void*)&this->attribute->am_model.am_V_menu_value;
		break;
	case 14:
		data = (void*)&this->attribute->am_model.am_V_menu_processing_time;
		break;
	case 15:
		data = (void*)&this->attribute->am_model.am_V_station_proc_time;
		break;
	case 16:
		data = (void*)&this->attribute->am_model.am_V_order_time;
		break;
	case 17:
		data = (void*)&this->attribute->am_model.am_V_menu_type;
		break;
	}
	return data;
}
...
set_attdata(load* this)
{
	...
	am_model.am_V_order_id$att->data = (void*)&this->attribute->am_model.am_V_order_id;
	am_model.am_V_arrival_time$att->data = (void*)&this->attribute->am_model.am_V_arrival_time;
	am_model.am_V_order_provenience$att->data = (void*)&this->attribute->am_model.am_V_order_provenience;
	am_model.am_V_order_dim$att->data = (void*)&this->attribute->am_model.am_V_order_dim;
	am_model.am_V_drink$att->data = (void*)&this->attribute->am_model.am_V_drink;
	am_model.am_V_chips$att->data = (void*)&this->attribute->am_model.am_V_chips;
	am_model.am_V_menu_pointer$att->data = (void*)&this->attribute->am_model.am_V_menu_pointer;
	am_model.am_V_stock_type$att->data = (void*)&this->attribute->am_model.am_V_stock_type;
	am_model.am_V_stock_location$att->data = (void*)this->attribute->am_model.am_V_stock_location;
	am_model.am_V_order_ready$att->data = (void*)&this->attribute->am_model.am_V_order_ready;
	am_model.am_V_order_level$att->data = (void*)&this->attribute->am_model.am_V_order_level;
	am_model.am_V_load_ptr$att->data = (void*)&this->attribute->am_model.am_V_load_ptr;
	am_model.am_V_load_type_ptrs$att->data = (void*)this->attribute->am_model.am_V_load_type_ptrs;
	am_model.am_V_menu_value$att->data = (void*)&this->attribute->am_model.am_V_menu_value;
	am_model.am_V_menu_processing_time$att->data = (void*)&this->attribute->am_model.am_V_menu_processing_time;
	am_model.am_V_station_proc_time$att->data = (void*)&this->attribute->am_model.am_V_station_proc_time;
	am_model.am_V_order_time$att->data = (void*)&this->attribute->am_model.am_V_order_time;
	am_model.am_V_menu_type$att->data = (void*)&this->attribute->am_model.am_V_menu_type;
}
